        ...
        <ScrollView>
            <View style={styles.container}>
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'bar' });
                    }}
                >
                    <MaterialIcons
                        name="local-bar"
                ...
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'cafe' });
                    }}
                >
                    <MaterialIcons
                        name="local-cafe"
                ...
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'park' });
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'cinema' });
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'hotel' });
                    }}
                >
                ...
                <TouchableOpacity
                    style={styles.block}
                    onPress={() => {
                        navigation.push('MapView', { text: 'museum' });
                    }}
                >
