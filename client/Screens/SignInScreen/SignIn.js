...
function SignIn({navigation}) {
    ...
    const handleSignInValidation = ()=>{
        let test_email = 'parth@gmail.com'
        let test_pass = 'parth'


        if(test_email === formData.Email &&
           test_pass  === formData.Password){
               console.log("Success");
        }else{
    ...
    return (
        <View style={signInPageStyle.container}>
            ...
            <View style={signInPageStyle.header}>
                <Text style={signInPageStyle.title}>
                Welcome back!
                </Text>
            ...
            <View style={signInPageStyle.body}>
                ...
                <View style={signInPageStyle.comnfieldViewStyle}>
                    ...
                    onEndEditing={(ele)=>{handleValidEmail(ele.nativeEvent.text)}}
                    >
                    </TextInput>
                </View>
                ...
                <TouchableOpacity
                    ...
                    <View style={signInPageStyle.button}>
                        <Text
                        style={signInPageStyle.btntext}
                        >Sign In</Text>
                    </View>
                </TouchableOpacity>
                {formData.nullInputs && 
                <Text style={signInPageStyle.errMsg}>
                null inputs</Text>
                }
                ...
                {/** SignUp Link */}
                    <View style={signInPageStyle.signUpView}>
                        <Text 
                        style={signInPageStyle.txt_signUpView}>
                        ...
                        onPress={()=>{
                            ...
                            <Text 
                            style={signInPageStyle.txt_signUpLink}
                            >Sign Up</Text>
                        </TouchableOpacity>
                    </View>
                </View>
